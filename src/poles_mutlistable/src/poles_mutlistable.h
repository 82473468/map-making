...
public:
    ...
    void publish_points(const ros::Publisher* in_publisher,const pcl::PointCloud<pcl::PointXYZI>::Ptr poles_cloud);
    ...
    void showcylinder(pcl::PointCloud<pcl::PointXYZI>::Ptr poles_position);
